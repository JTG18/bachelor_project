...
for sender in senders:
    for iteration in range(iterations):
        ...
        for a in range(len(ids)):
            ...
            if(sender == id):
                ...
                substring = "sender_id:" + str(sender)
            ...
            if (sender == id):
                ...
                for line in lines:
                    ...
                    try:
                        ...
                        print("Node " + str(id) + " in it " + str(iteration))
                        print(parts)
                        continue
                    #put into data
    ...
    for a in range(len(ids)):
        ...
        latencies[a].extend(latency)
        reliability[a] += arrived
...
for a in range(len(ids)):
    ...
    if id in senders:
        ...
        rel.append((reliability[a]/total) * 100.0)
