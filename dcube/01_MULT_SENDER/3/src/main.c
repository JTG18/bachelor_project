...
static uint8_t cmp_uuid[3][16] = {{0xec, 0xb4, 0x53, 0x12, 0x16, 0x7c, 0x7c, 0x75, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, //ID: 108
...
bool uuid_in_list(uint8_t uuid1[16], uint8_t uuid_list[3][16])
{
	int i;
	int j;
	for (j = 0; j < 3; j++)
