							   ...
							   struct net_buf_simple *buf)
{
	 ...
	 */
	k_work_reschedule(&onoff.work, K_MSEC(0));
...
static int gen_onoff_send(bool val)
{
	...
	int payload_size = (8+16+8+64+64+64+16)/8;
...
// test  	{0x1d, 0xa7, 0x46, 0x60, 0x08, 0xd5, 0xa0, 0x2c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
static uint8_t cmp_uuid[16] = {0xe5, 0x54, 0x39, 0x6d, 0xf1, 0x11, 0xde, 0x36, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
